...
class KeyOperationAttestation(proto.Message):
    ...
    Attributes:
        format_ (google.cloud.kms_v1.types.KeyOperationAttestation.AttestationFormat):
    ...
    format_ = proto.Field(proto.ENUM, number=4,
...
class PublicKey(proto.Message):
    ...
    pem_crc32c = proto.Field(proto.MESSAGE, number=3,
