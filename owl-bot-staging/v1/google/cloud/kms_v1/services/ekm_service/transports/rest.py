...
class EkmServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_ekm_connection(self, response: ekm_service.EkmConnection) -> ekm_service.EkmConnection:
        ...
        """
        return response
    def pre_get_ekm_config(self, request: ekm_service.GetEkmConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ekm_service.GetEkmConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_ekm_connections(self, response: ekm_service.ListEkmConnectionsResponse) -> ekm_service.ListEkmConnectionsResponse:
        ...
        """
        return response
    def pre_update_ekm_config(self, request: ekm_service.UpdateEkmConfigRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ekm_service.UpdateEkmConfigRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_update_ekm_connection(self, response: ekm_service.EkmConnection) -> ekm_service.EkmConnection:
        ...
        """
        return response
    def pre_verify_connectivity(self, request: ekm_service.VerifyConnectivityRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[ekm_service.VerifyConnectivityRequest, Sequence[Tuple[str, str]]]:
