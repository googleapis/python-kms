...
class EkmServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(EkmServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(EkmServiceClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(EkmServiceClient.parse_common_organization_path)
    ...
    parse_common_location_path = staticmethod(EkmServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(EkmServiceClient).get_transport_class, type(EkmServiceClient))
    ...
    async def list_ekm_connections(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_ekm_connection(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_ekm_connection(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_ekm_connection(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_ekm_config(self,
