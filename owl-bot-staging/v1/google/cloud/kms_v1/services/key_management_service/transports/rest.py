...
class KeyManagementServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_mac_verify(self, response: service.MacVerifyResponse) -> service.MacVerifyResponse:
        ...
        """
        return response
    def pre_raw_decrypt(self, request: service.RawDecryptRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.RawDecryptRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_raw_decrypt(self, response: service.RawDecryptResponse) -> service.RawDecryptResponse:
        ...
        """
        return response
    def pre_raw_encrypt(self, request: service.RawEncryptRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[service.RawEncryptRequest, Sequence[Tuple[str, str]]]:
