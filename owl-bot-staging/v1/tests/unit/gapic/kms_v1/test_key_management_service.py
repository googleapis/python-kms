...
@pytest.mark.parametrize("client_class", [
    KeyManagementServiceClient, KeyManagementServiceAsyncClient
])
@mock.patch.object(KeyManagementServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(KeyManagementServiceClient))
@mock.patch.object(KeyManagementServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(KeyManagementServiceAsyncClient))
...
def test_raw_encrypt(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.raw_encrypt),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_raw_decrypt(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.raw_decrypt),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_mac_sign(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.mac_sign),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_mac_verify(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.mac_verify),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_generate_random_bytes(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.generate_random_bytes),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_key_rings_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = service.ListKeyRingsResponse.pb(return_value)
...
def test_list_key_rings_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_list_key_rings") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_list_key_rings") as pre:
...
def test_list_crypto_keys_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.ListCryptoKeysResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_crypto_keys_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_list_crypto_keys") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_list_crypto_keys") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_crypto_key_versions_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.ListCryptoKeyVersionsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_crypto_key_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_list_crypto_key_versions") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_list_crypto_key_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_import_jobs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.ListImportJobsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_import_jobs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_list_import_jobs") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_list_import_jobs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_key_ring_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = resources.KeyRing.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_key_ring_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_get_key_ring") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_get_key_ring") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_crypto_key_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = resources.CryptoKey.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_crypto_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_get_crypto_key") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_get_crypto_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_crypto_key_version_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = resources.CryptoKeyVersion.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_crypto_key_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_get_crypto_key_version") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_get_crypto_key_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_public_key_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = resources.PublicKey.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_public_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_get_public_key") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_get_public_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_import_job_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = resources.ImportJob.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_import_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_get_import_job") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_get_import_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_key_ring_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_create_key_ring") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_create_key_ring") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_crypto_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_create_crypto_key") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_create_crypto_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_crypto_key_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_create_crypto_key_version") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_create_crypto_key_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_import_crypto_key_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_import_crypto_key_version") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_import_crypto_key_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_import_job_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_create_import_job") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_create_import_job") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_crypto_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_update_crypto_key") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_update_crypto_key") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_crypto_key_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_update_crypto_key_version") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_update_crypto_key_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_crypto_key_primary_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_update_crypto_key_primary_version") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_update_crypto_key_primary_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_destroy_crypto_key_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_destroy_crypto_key_version") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_destroy_crypto_key_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_restore_crypto_key_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_restore_crypto_key_version") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_restore_crypto_key_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_encrypt_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.EncryptResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_encrypt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_encrypt") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_encrypt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_decrypt_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.DecryptResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_decrypt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_decrypt") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_decrypt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_raw_encrypt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_raw_encrypt") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_raw_encrypt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_raw_decrypt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_raw_decrypt") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_raw_decrypt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_asymmetric_sign_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.AsymmetricSignResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_asymmetric_sign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_asymmetric_sign") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_asymmetric_sign") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_asymmetric_decrypt_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.AsymmetricDecryptResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_asymmetric_decrypt_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_asymmetric_decrypt") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_asymmetric_decrypt") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_mac_sign_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.MacSignResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_mac_sign_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_mac_sign") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_mac_sign") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_mac_verify_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.MacVerifyResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_mac_verify_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_mac_verify") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_mac_verify") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_random_bytes_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = service.GenerateRandomBytesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_generate_random_bytes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "post_generate_random_bytes") as post, \
         mock.patch.object(transports.KeyManagementServiceRestInterceptor, "pre_generate_random_bytes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
