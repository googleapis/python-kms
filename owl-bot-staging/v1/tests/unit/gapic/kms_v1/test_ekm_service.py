...
@pytest.mark.parametrize("client_class", [
    EkmServiceClient, EkmServiceAsyncClient
])
@mock.patch.object(EkmServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EkmServiceClient))
@mock.patch.object(EkmServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(EkmServiceAsyncClient))
...
def test_update_ekm_connection(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_ekm_connection),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = ekm_service.EkmConnection(
            name='name_value',
...
def test_get_ekm_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_ekm_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_update_ekm_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_ekm_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = ekm_service.EkmConfig(
            name='name_value',
...
def test_verify_connectivity(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.verify_connectivity),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_ekm_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.EkmServiceRestInterceptor, "post_list_ekm_connections") as post, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "pre_list_ekm_connections") as pre:
...
def test_get_ekm_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "post_get_ekm_connection") as post, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "pre_get_ekm_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_ekm_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "post_create_ekm_connection") as post, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "pre_create_ekm_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_ekm_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "post_update_ekm_connection") as post, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "pre_update_ekm_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_ekm_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "post_get_ekm_config") as post, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "pre_get_ekm_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_ekm_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "post_update_ekm_config") as post, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "pre_update_ekm_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_verify_connectivity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "post_verify_connectivity") as post, \
         mock.patch.object(transports.EkmServiceRestInterceptor, "pre_verify_connectivity") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_ekm_service_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.EkmServiceGrpcTransport, transports.EkmServiceGrpcAsyncIOTransport])
def test_ekm_service_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.EkmServiceGrpcTransport, transports.EkmServiceGrpcAsyncIOTransport])
def test_ekm_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
