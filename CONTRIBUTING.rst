...
- While logged into your GitHub account, navigate to the
  ``python-kms`` `repo`_ on GitHub.

- Fork and clone the ``python-kms`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-kms`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-kms``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-kms.git hack-on-python-kms
   $ cd hack-on-python-kms
   # Configure remotes such that you can pull changes from the googleapis/python-kms
   # repository into your local repository.
   $ git remote add upstream git@github.com:googleapis/python-kms.git
...
.. _repo: https://github.com/googleapis/python-kms
