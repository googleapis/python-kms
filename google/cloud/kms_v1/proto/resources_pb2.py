...
CryptoKey = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      primary:
          ...
          rsion].  Keys with
          [purpose][google.cloud.kms.v1.CryptoKey.purpose] [ENCRYPT_DECR
          YPT][google.cloud.kms.v1.CryptoKey.CryptoKeyPurpose.ENCRYPT_DE
          CRYPT] may have a primary. For other keys, this field will be
          omitted.
      purpose:
      ...
      next_rotation_time:
          At [next_rotation_time][google.cloud.kms.v1.CryptoKey.next_rot
          ation_time], the Key Management Service will automatically:
          ...
          ersion] do not affect [next_rotation_time][google.cloud.kms.v1
          .CryptoKey.next_rotation_time].  Keys with
          [purpose][google.cloud.kms.v1.CryptoKey.purpose] [ENCRYPT_DECR
          YPT][google.cloud.kms.v1.CryptoKey.CryptoKeyPurpose.ENCRYPT_DE
          CRYPT] support automatic rotation. For other keys, this field
          must be omitted.
      rotation_schedule:
          Controls the rate of automatic rotation.
      rotation_period:
          [next_rotation_time][google.cloud.kms.v1.CryptoKey.next_rotati
          on_time] will be advanced by this period when the service
          automatically rotates a key. Must be at least 24 hours and at
          most 876,000 hours.  If [rotation_period][google.cloud.kms.v1.
          CryptoKey.rotation_period] is set, [next_rotation_time][google
          .cloud.kms.v1.CryptoKey.next_rotation_time] must also be set.
          Keys with [purpose][google.cloud.kms.v1.CryptoKey.purpose] [EN
          CRYPT_DECRYPT][google.cloud.kms.v1.CryptoKey.CryptoKeyPurpose.
...
CryptoKeyVersionTemplate = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      algorithm:
          ...
          GOOGLE_SYMMETRIC_ENCRYPTION is implied if both this field is
          omitted and
          [CryptoKey.purpose][google.cloud.kms.v1.CryptoKey.purpose] is 
          [ENCRYPT_DECRYPT][google.cloud.kms.v1.CryptoKey.CryptoKeyPurpo
          se.ENCRYPT_DECRYPT].
  """,
...
CryptoKeyVersion = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      attestation:
          ...
          Google. Only provided for key versions with [protection_level]
          [google.cloud.kms.v1.CryptoKeyVersion.protection_level]
      ...
      destroy_time:
          ...
          Y_SCHEDULED][google.cloud.kms.v1.CryptoKeyVersion.CryptoKeyVer
          sionState.DESTROY_SCHEDULED].
      destroy_event_time:
      ...
      import_failure_reason:
          ...
          ORT_FAILED][google.cloud.kms.v1.CryptoKeyVersion.CryptoKeyVers
          ionState.IMPORT_FAILED].
      external_protection_level_options:
...
ImportJob = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      protection_level:
          ...
          the [protection_level][google.cloud.kms.v1.CryptoKeyVersionTem
          plate.protection_level] of the [version_template][google.cloud
          .kms.v1.CryptoKey.version_template] on the
