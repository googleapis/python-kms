...
ListKeyRingsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_size:
          ...
          e.next_page_token][google.cloud.kms.v1.ListKeyRingsResponse.ne
          xt_page_token] in a subsequent request. If unspecified, the
          server will pick an appropriate default.
      page_token:
          Optional. Optional pagination token, returned earlier via [Lis
          tKeyRingsResponse.next_page_token][google.cloud.kms.v1.ListKey
          RingsResponse.next_page_token].
      filter:
...
ListCryptoKeysRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_size:
          ...
          esponse.next_page_token][google.cloud.kms.v1.ListCryptoKeysRes
          ponse.next_page_token] in a subsequent request. If
          unspecified, the server will pick an appropriate default.
      page_token:
          Optional. Optional pagination token, returned earlier via [Lis
          tCryptoKeysResponse.next_page_token][google.cloud.kms.v1.ListC
          ryptoKeysResponse.next_page_token].
      version_view:
...
ListCryptoKeyVersionsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_size:
          ...
          nsResponse.next_page_token][google.cloud.kms.v1.ListCryptoKeyV
          ersionsResponse.next_page_token] in a subsequent request. If
          unspecified, the server will pick an appropriate default.
      page_token:
          Optional. Optional pagination token, returned earlier via [Lis
          tCryptoKeyVersionsResponse.next_page_token][google.cloud.kms.v
          1.ListCryptoKeyVersionsResponse.next_page_token].
      view:
...
ListImportJobsRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      page_size:
          ...
          esponse.next_page_token][google.cloud.kms.v1.ListImportJobsRes
          ponse.next_page_token] in a subsequent request. If
          unspecified, the server will pick an appropriate default.
      page_token:
          Optional. Optional pagination token, returned earlier via [Lis
          tImportJobsResponse.next_page_token][google.cloud.kms.v1.ListI
          mportJobsResponse.next_page_token].
      filter:
          Optional. Only include resources that match the filter in the
          response. For more information, see `Sorting and filtering
          list results <https://cloud.google.com/kms/docs/sorting-and-
...
ListKeyRingsResponse = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      next_page_token:
          ...
          ListKeyRingsRequest.page_token][google.cloud.kms.v1.ListKeyRin
          gsRequest.page_token] to retrieve the next page of results.
      total_size:
...
ListCryptoKeysResponse = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      next_page_token:
          A token to retrieve next page of results. Pass this value in [
          ListCryptoKeysRequest.page_token][google.cloud.kms.v1.ListCryp
          toKeysRequest.page_token] to retrieve the next page of
          results.
      total_size:
          The total number of
...
ListCryptoKeyVersionsResponse = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      next_page_token:
          A token to retrieve next page of results. Pass this value in [
          ListCryptoKeyVersionsRequest.page_token][google.cloud.kms.v1.L
          istCryptoKeyVersionsRequest.page_token] to retrieve the next
          page of results.
      total_size:
          The total number of
...
ListImportJobsResponse = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      next_page_token:
          A token to retrieve next page of results. Pass this value in [
          ListImportJobsRequest.page_token][google.cloud.kms.v1.ListImpo
          rtJobsRequest.page_token] to retrieve the next page of
          results.
      total_size:
          The total number of
...
ImportCryptoKeyVersionRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      algorithm:
          ...
          does not need to match the [version_template][google.cloud.kms
          .v1.CryptoKey.version_template] of the
      ...
      wrapped_key_material:
          ...
          imported.
      rsa_aes_wrapped_key:
          Wrapped key material produced with [RSA_OAEP_3072_SHA1_AES_256
          ][google.cloud.kms.v1.ImportJob.ImportMethod.RSA_OAEP_3072_SHA
          1_AES_256] or [RSA_OAEP_4096_SHA1_AES_256][google.cloud.kms.v1
          .ImportJob.ImportMethod.RSA_OAEP_4096_SHA1_AES_256].  This
          field contains the concatenation of two wrapped keys:  ..
          raw:: html     <ol>  .. raw:: html     <li>  An ephemeral
          AES-256 wrapping key wrapped with the
...
EncryptRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      plaintext:
          ...
          The maximum size depends on the key version’s [protection_leve
          l][google.cloud.kms.v1.CryptoKeyVersionTemplate.protection_lev
          el]. For
      ...
      additional_authenticated_data:
          ...
          provided during decryption through [DecryptRequest.additional_
          authenticated_data][google.cloud.kms.v1.DecryptRequest.additio
          nal_authenticated_data].  The maximum size depends on the key
          version’s [protection_level][google.cloud.kms.v1.CryptoKeyVers
          ionTemplate.protection_level]. For
          [SOFTWARE][google.cloud.kms.v1.ProtectionLevel.SOFTWARE] keys,
...
DecryptRequest = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      additional_authenticated_data:
          ...
          supplied in [EncryptRequest.additional_authenticated_data][goo
          gle.cloud.kms.v1.EncryptRequest.additional_authenticated_data]
          .
  """,
...
LocationMetadata = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      hsm_available:
          ...
          with [protection_level][google.cloud.kms.v1.CryptoKeyVersionTe
          mplate.protection_level]
